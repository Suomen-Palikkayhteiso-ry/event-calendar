        ...
        [ describe "parseEventName"
            [ test "should parse event name with country and dates" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseEventName "Event Title (FIN) 15-20 July"
                    in
            ...
            , test "should parse event name with country only" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseEventName "Event Title (FIN)"
                    in
            ...
            , test "should parse event name without country" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseEventName "Event Title"
                    in
        ...
        , describe "parseDateString"
            [ test "should parse mid month date" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseDateString "mid July" 2024
                    in
            ...
            , test "should parse in month date" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseDateString "in July" 2024
                    in
            ...
            , test "should parse day range" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseDateString "July 15-20" 2024
                    in
            ...
            , test "should parse single day" <|
                \_ ->
                    let
                        result =
                            KMLUtils.parseDateString "July 15" 2024
                    in
                    Expect.equal result { startDate = Just "2024-07-15", endDate = Just "2024-07-15" }
            ]
        ]
