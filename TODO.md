...
* [x] Write TODO.md tasks to go through every currently completed task, also in other TODO-.*.md files, to double check the tasks have been completed and then remove completed taskd and completed TODO-.*.md files.