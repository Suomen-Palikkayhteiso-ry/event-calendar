	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CreateEvent':
				...
				return _Utils_Tuple2(
					model,
					A3($author$project$PocketBase$createEvent, token, event, $author$project$Events$EventCreated));
			case 'EventCreated':
				var result = msg.a;
				if (result.$ === 'Ok') {
			...
			case 'UpdateEvent':
				...
				return _Utils_Tuple2(
					model,
					A4($author$project$PocketBase$updateEvent, token, id, updatedEvent, $author$project$Events$EventUpdated));
			case 'EventUpdated':
				var result = msg.a;
				if (result.$ === 'Ok') {
...
var $author$project$Events$DeleteEvent = F2(
	function (a, b) {
...
var $author$project$Ports$parseKMLContent = _Platform_outgoingPort('parseKMLContent', $elm$json$Json$Encode$string);
var $author$project$DateUtils$daysSinceEpoch = F3(
	function (year, month, day) {
		var a = ((14 - month) / 12) | 0;
		var m = (month + (12 * a)) - 3;
		var y = (year + 4800) - a;
		var jd = (((((day + ((((153 * m) + 2) / 5) | 0)) + (365 * y)) + ((y / 4) | 0)) - ((y / 100) | 0)) + ((y / 400) | 0)) - 32045;
		return jd - 2440588;
	});
							...
							if (_v11.$ === 'Just') {
								...
								if (_v12.$ === 'Just') {
									...
									if (_v13.$ === 'Just') {
										...
										var millis = ((((((days * 24) * 60) * 60) * 1000) + (((h * 60) * 60) * 1000)) + ((min * 60) * 1000)) + (s * 1000);
...
var $author$project$KMLUtils$parseDateString = F2(
			...
			if (_v0.b && _v0.b.b) {
				...
				if (_v2.$ === 'Just') {
					...
					var dateStr_ = $author$project$DateUtils$dateToString(
						{day: 15, month: month + 1, year: year});
					return {
				...
				var _v3 = $elm$core$List$head(
					A2(
						...
						$elm$core$String$trim(
							A2($elm$core$String$dropLeft, 3, lower))));
				if (_v3.$ === 'Just') {
					var monthName = _v3.a;
					...
					if (_v4.$ === 'Just') {
						...
						var end = $author$project$DateUtils$dateToString(
							{day: endDay, month: month + 1, year: year});
						return {
				...
				if (_v6.b && _v6.b.b) {
					...
					var _v8 = _Utils_Tuple2(
						...
						A2(
							...
							$elm$core$List$head(day1Parts)));
					if ((_v8.a.$ === 'Just') && (_v8.b.$ === 'Just')) {
						var month = _v8.a.a;
						var day1 = _v8.b.a;
						var start = $author$project$DateUtils$dateToString(
							{day: day1, month: month + 1, year: year});
						var day2 = function () {
						...
						var end = $author$project$DateUtils$dateToString(
							{day: day2, month: month + 1, year: year});
						return {
							endDate: $elm$core$Maybe$Just(end),
							startDate: $elm$core$Maybe$Just(start)
						};
...
var $author$project$KMLUtils$parseEventName = function (name) {
	...
	var _v0 = _Utils_Tuple2(
		$elm$core$List$head(openParen),
		$elm$core$List$head(closeParen));
	if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
		var open = _v0.a.a;
		var close = _v0.b.a;
		if (_Utils_cmp(open, close) < 0) {
			var title = $elm$core$String$trim(
				A2($elm$core$String$left, open, name));
			var dates = $elm$core$String$trim(
				A2($elm$core$String$dropLeft, close + 1, name));
			var country = $elm$core$String$trim(
				A3($elm$core$String$slice, open + 1, close, name));
			return {
				country: $elm$core$String$isEmpty(country) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(country),
				dates: $elm$core$String$isEmpty(dates) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(dates),
				title: title
			};
		} else {
		...
		return $elm$core$Maybe$Just(
			{
				...
				location: $elm$core$String$isEmpty(location) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(location),
				point: ((!(!raw.lat)) || (!(!raw.lon))) ? $elm$core$Maybe$Just(
					{lat: raw.lat, lon: raw.lon}) : $elm$core$Maybe$Nothing,
...
var $author$project$KMLUtils$RawKMLData = F4(
...
var $author$project$Calendar$daysSince1970 = F3(
	function (year, month, day) {
		var years = year - 1970;
		var leapYears = (((years / 4) | 0) - ((years / 100) | 0)) + ((years / 400) | 0);
		var daysInYears = (years * 365) + leapYears;
		var daysInMonths = $author$project$Calendar$daysInMonthsBefore(month) + ((($author$project$Calendar$monthToInt(month) > 1) && $author$project$Calendar$isLeapYear(year)) ? 1 : 0);
		return ((daysInYears + daysInMonths) + day) - 1;
	});
var $author$project$Calendar$dateToPosix = F3(
	function (year, month, day) {
		var daysSinceEpoch = A3($author$project$Calendar$daysSince1970, year, month, day);
		var millis = (((daysSinceEpoch * 24) * 60) * 60) * 1000;
		return $elm$time$Time$millisToPosix(millis);
	});
var $author$project$Calendar$daysInMonth = F2(
	function (year, month) {
		switch (month.$) {
			case 'Feb':
...
var $author$project$EventForm$UpdateEvent = F2(
	function (a, b) {
...
var $author$project$EventForm$toEvent = function (model) {
	return {
		...
		endDate: $elm$core$String$isEmpty(model.endDate) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(model.endDate),
		id: '',
		image: model.image,
		imageDescription: $elm$core$String$isEmpty(model.imageDescription) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(model.imageDescription),
		location: $elm$core$String$isEmpty(model.location) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(model.location),
		point: model.point,
		startDate: model.startDate,
		state: model.state,
		title: model.title,
		updated: '',
		url: $elm$core$String$isEmpty(model.url) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(model.url)
	};
};
	...
	function (msg, model) {
		switch (msg.$) {
					...
					if (_v1.$ === 'Create') {
						return _Utils_Tuple2(
							_Utils_update(
								...
								{loading: true}),
							$elm$core$Maybe$Just(
								$author$project$EventForm$CreateEvent(
			...
			case 'LoadEvent':
				var event = msg.a;
				return _Utils_Tuple2(
					$author$project$EventForm$fromEvent(event),
					$elm$core$Maybe$Nothing);
			default:
				var loading = msg.a;
				return _Utils_Tuple2(
		...
		switch (msg.$) {
			...
			case 'ToggleImportModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showImportModal: !model.showImportModal}),
					$elm$core$Platform$Cmd$none);
			case 'NoOp':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'SelectKMLFile':
				...
				switch (newRoute.$) {
					case 'CreateEvent':
						return _Utils_Tuple2(
							_Utils_update(
								newModel,
								{eventForm: $author$project$EventForm$init}),
							$elm$core$Platform$Cmd$none);
					case 'EditEvent':
						var id = newRoute.a;
						var _v3 = $elm$core$List$head(
			...
			case 'LogoutResult':
				...
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{auth: $elm$core$Maybe$Nothing, error: $elm$core$Maybe$Nothing, loading: false}),
...
var $author$project$Calendar$addDays = F2(
	function (days, posix) {
		var millis = $elm$time$Time$posixToMillis(posix) + $elm$core$Basics$round((((days * 24) * 60) * 60) * 1000);
		return $elm$time$Time$millisToPosix(millis);
	});
...
var $author$project$Calendar$endOfWeek = F2(
	function (posix, firstDay) {
...
var $author$project$Calendar$firstOfMonthPosix = F2(
	function (year, month) {
...
var $author$project$Calendar$generateDays = F3(
	function (start, end, currentMonth) {
		var startMillis = $elm$time$Time$posixToMillis(start);
		var endMillis = $elm$time$Time$posixToMillis(end);
		var days = A4($author$project$Calendar$generateDaysHelper, startMillis, endMillis, currentMonth, _List_Nil);
		return $elm$core$List$reverse(days);
	});
var $author$project$Calendar$lastOfMonthPosix = F2(
	function (year, month) {
		return A3(
...
var $author$project$Calendar$startOfWeek = F2(
	function (posix, firstDay) {
		var weekday = A2($elm$time$Time$toWeekday, $elm$time$Time$utc, posix);
		var weekdayInt = $author$project$Calendar$weekdayToInt(weekday);
...
var $author$project$Calendar$groupByWeeks = function (days) {
	if (!days.b) {
		...
		return A2(
			$elm$core$List$cons,
			week,
			$author$project$Calendar$groupByWeeks(rest));
	}
};
...
var $author$project$Calendar$viewEvent = function (event) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('calendar-event')
			]),
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('calendar-day-number')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(
							A2($elm$time$Time$toDay, $elm$time$Time$utc, day.date)))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('calendar-day-events')
					]),
...
var $author$project$Calendar$weekdayHeader = function (weekdayInt) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('calendar-weekday')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Calendar$weekdayToString(weekday))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Calendar$Previous)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('<')
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Calendar$monthYearString(model.currentDate))
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Calendar$Next)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('>')
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('calendar-week-header')
									]),
								A2(
									$elm$core$List$map,
...
var $author$project$DateUtils$formatDateInHelsinki = F2(
	function (utcString, allDay) {
		...
		var dateStr = $elm$core$String$fromInt(day) + ('.' + ($elm$core$String$fromInt(
			$author$project$DateUtils$monthToInt(month)) + ('.' + $elm$core$String$fromInt(year))));
		if (allDay) {
			return dateStr;
		} else {
...
var $author$project$EventDetail$view = F2(
	function (event, auth) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					if (_v1.$ === 'Just') {
						...
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$src('https://data.suomenpalikkayhteiso.fi/api/files/events/' + (event.id + ('/' + imgPath))),
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('mb-4 whitespace-pre-wrap')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$text(
									A2($elm$core$Maybe$withDefault, '', event.location))
								])),
							function () {
							var _v2 = event.url;
							if (_v2.$ === 'Just') {
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('mt-8 inline-block text-blue-600 underline bg-transparent border-0 cursor-pointer')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Back to Calendar')
						]))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{allDay: model.allDay, disabled: false, id: 'startDate', label: 'Start Date', onChange: $author$project$EventForm$SetStartDate, value: model.startDate}),
				$author$project$DateTimePicker$view(
				{allDay: model.allDay, disabled: false, id: 'endDate', label: 'End Date', onChange: $author$project$EventForm$SetEndDate, value: model.endDate}),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						model.loading ? 'Submitting...' : 'Submit')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(event.startDate)
					])),
				A2(
				$elm$html$Html$td,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								'px-2 inline-flex text-xs leading-5 font-semibold rounded-full ' + $author$project$EventList$statusColor(event.state))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$EventList$DeleteEvent(event.id)),
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full')
												]),
											_List_fromArray(
												[
													A2(
														...
														[
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$elm$html$Html$Attributes$class('bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700'),
																			$elm$html$Html$Events$onClick($author$project$EventList$SelectKMLFile)
																		]),
																	_List_fromArray(
																		[
...
var $author$project$EventList$viewPagination = F2(
	function (model, totalItems) {
		var totalPages = $elm$core$Basics$ceiling(totalItems / model.pageSize);
		return (totalPages <= 1) ? $elm$html$Html$text('') : A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$class('ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('hidden sm:flex-1 sm:flex sm:items-center sm:justify-between')
						]),
					_List_fromArray(
						[
							A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													$elm$core$String$fromInt(model.currentPage))
												])),
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													$elm$core$String$fromInt(totalPages))
												]))
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('relative z-0 inline-flex rounded-md shadow-sm -space-x-px'),
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$EventList$SetPage(
														A2($elm$core$Basics$max, 1, model.currentPage - 1))),
													$elm$html$Html$Attributes$disabled(model.currentPage === 1),
													$elm$html$Html$Attributes$class('relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50')
												]),
											_List_fromArray(
												[
													A2(
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$disabled(
													_Utils_eq(model.currentPage, totalPages)),
													$elm$html$Html$Attributes$class('relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50')
												]),
											_List_fromArray(
												[
													A2(
...
var $author$project$EventList$view = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 block'),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider')
														]),
													_List_fromArray(
														[
